...
```
GIVEN a webpage meets accessibility standards // alt tag
WHEN I view the source code //header main footer
...
THEN I find a concise, descriptive title //marketing company
```
